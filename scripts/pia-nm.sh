#!/bin/bash
#
# forked copy from https://www.privateinternetaccess.com/installer/pia-nm.sh
#
####################################################
# TODO:
#
# add check for uuidgen (uuid-runtime) dependency
# gnome-keyring check bypass
# password-flags=0
# add prompt for password on CLI (insecure, possibly shows in process list?)
#
####################################################
#
